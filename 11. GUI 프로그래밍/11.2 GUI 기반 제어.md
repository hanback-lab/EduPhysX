...
## 주의 사항 
Serial 통신에 활용되는 포트는 한번에 1개의 프로그램에서 접근하게되어 있습니다. 아두이노 Mega2560 의 기본 Serial 은 USB와 연결되어 있고 이를 통해 프로그램 다운로드 및 각종 정보 출력, 키보드 입력등을 받을 수 있습니다. 
...
따라서, 아래의 프로그램들을 다운로드하고 실행하는 실습을 진행할 때 동시에 접근하는 일이 없도록 주의하며 실습을 진행합니다. 
