...
> **참고**: Arduino Mega 2560에서 PWM 제어가 가능한 핀은 `3, 5, 6, 7, 8, 9, 10, 11, 12, 13, 44, 45, 46` 번 핀입니다.  
> PWM 지원 핀이 아닌 경우 analogWrite()를 사용해도 밝기 제어가 되지 않고, 단순히 켜짐/꺼짐만 반복되는 것처럼 보일 수 있습니다.
